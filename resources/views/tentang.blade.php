...
@section('content')
    ...
    <div class="min-h-screen bg-gray-50 py-16">
        <div class="max-w-7xl mx-auto px-6">
            ...
            <!-- Main Content -->
            <div class="grid grid-cols-1  gap-12 items-center mt-24">
                <!-- Image Section -->
                <div class="order-2 lg:order-1">
                    <div class="relative rounded-2xl overflow-hidden shadow-2xl">
                        <img src="{{ asset('images/banner-1.jpg') }}    " alt="Armada Store Interior"
                ...
                <div class="order-1 lg:order-2 space-y-6">
                    <div>
                        <h1 class="text-4xl lg:text-5xl font-bold  mb-4 text-blue-800"
                            style="font-family: 'Poppins', sans-serif;">
                            Toko Ga`de
                        </h1>
                        <div class="w-20 h-1 bg-blue-800 mb-6"></div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-8">
                        ...
                        <div class="flex items-center space-x-3">
                            <div class="w-12 h-12  rounded-lg flex items-center justify-center">
                                <svg class="w-9 h-9 text-blue-800  " fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="pt-6">
                        <a href="/etalase"
                            class="inline-flex items-center px-6 py-3 bg-blue-800   text-white font-semibold rounded-lg hover:shadow-lg transition-colors duration-300">
                            Lihat Produk Kami
            ...
            <div class="mt-20 bg-white rounded-2xl shadow-lg p-8">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                    <div class="text-center">
                        <div class="text-3xl font-bold text-blue-800    mb-2">5+</div>
                        <p class="text-gray-600">Tahun Berpengalaman</p>
                    </div>
                    <div class="text-center">
                        <div class="text-3xl font-bold text-blue-800    mb-2">1000+</div>
                        <p class="text-gray-600">Produk Tersedia</p>
                    </div>
                    <div class="text-center">
                        <div class="text-3xl font-bold text-blue-800    mb-2">5000+</div>
                        <p class="text-gray-600">Pelanggan Puas</p>
                    </div>
                    <div class="text-center">
                        <div class="text-3xl font-bold text-blue-800    mb-2">24/7</div>
